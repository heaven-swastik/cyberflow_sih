...
def train_all_models(data_path=None, output_dir=None, num_cases=300):
    ...
    # Instead of a randomized split, we simulate a real-world scenario by training
    # on the first 80% of chronological cases and testing on the final 20% unseen future cases.
